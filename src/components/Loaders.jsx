export const Loaders = () => {
  return (
    <>
      <div className="flex flex-col justify-center w-screen  bg-neutral-300 h-screen animate-pulse rounded-xl p-4 gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-neutral-400/50 w- h-10 animate-pulse rounded-md"></div>
          <div className="bg-neutral-400/50 w-full h-6 animate-pulse rounded-md"></div>
          <div className="bg-neutral-400/50 w-2/3 h-5 animate-pulse rounded-md"></div>
