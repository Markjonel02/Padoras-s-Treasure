...
const Login = () => {
  return (
    <>
      ...
      <div className="relative z-10 min-h-full w-[600px] flex flex-col items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8 rounded-lg">
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="flex flex-col items-center">
            ...
            <FaCircleUser className="w-20 h-20 text-gray-400 flex justify-center" />
          </div>
          <Formik
          ...
          >
            {({ isSubmitting }) => (
              <Form className="relative z-10 mt-8 space-y-6">
                <Field
                  type="text"
                  name="username"
